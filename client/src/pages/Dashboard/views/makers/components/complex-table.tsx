...
import EditMakerWidget from "../widget/edit-maker.widget";
...
export default function ComplexTable(props: { tableData: any }) {
  ...
  let [makerSelected,setMakerSelected] = useState("")
  ...
  return (
    <Card extra={"w-full h-full px-6 pb-6 sm:overflow-x-auto"}>
      ...
      <EditMakerWidget id={makerSelected} isOpen={isOpenEdit} closeModal={closeModalEdit} />
