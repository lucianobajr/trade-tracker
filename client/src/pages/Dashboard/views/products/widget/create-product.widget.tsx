    ...
    const handleSubmit = useCallback(async (data: FormData) => {
        ...
        try {
            ...
            const schema = Yup.object().shape({
                ...
                cost_price: Yup.number().required("Preço de custo é obrigatório"),
                selling_price: Yup.number().required("Preço de venda obrigatório"),
                stock: Yup.number().required("Estoque é obrigatório"),
                makerId: Yup.string().required("Id do Fabricante obrigatório"),
            });
